...
public class CallActivity extends Activity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        logAndToast(TAG +" testing: "+intent.toString());
        ...
        try {
            ...
            //socket = IO.socket(roomUri.toString(), opt);
            ...
            socket.on("respDoCalling", new Emitter.Listener() {
                ...
                public void call(Object... args) {
                    try {
                        ...
                        //Log.d("my resp", resp.getJSONObject("params").getString("is_initiator"));
                        Log.d("my resp", resp.getString("params"));
                        //respDoCalling = resp.getString("params");
    ...
    private Emitter.Listener onConnectionError = new Emitter.Listener() {
        ...
        public void call(Object... args) {
            ...
            CallActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(getApplicationContext(), R.string.socket_connect_error, Toast.LENGTH_LONG).show();
                }
            });
